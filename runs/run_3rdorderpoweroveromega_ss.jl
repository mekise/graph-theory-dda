...
G12 = 1/8/π^2
alphas = [(1/2)*(G12/Complex(2*sqrt(2)*G12^6 + 3*G12^6)^(1/3) + ((2*sqrt(2) + 3)^(1/3)*Complex(G12^6)^(1/3))/G12^3 + 1/G12)
          -(-2 + ((3 + 2*sqrt(2))^(1/3)*Complex(G12^6)^(1/3))/G12^2 + Complex(G12^6)^(2/3)/((3 + 2*sqrt(2))^(1/3)*G12^4) + 
